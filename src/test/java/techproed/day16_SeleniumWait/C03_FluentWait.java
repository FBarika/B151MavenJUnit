 ...
 max. belirtmiş olduğumuz süre kadar bizim belirttiğimiz aralıklarda (saniye/salise) bekler
    */
    ...
    public void test01() {
        ...
        wait.withTimeout(Duration.ofSeconds(20)).//FluentWait icin max bekleme süresini belirtir.
        pollingEvery(Duration.ofMillis(200)).//--> 200 Milisaniye araliklarla webelementin etkilesime girdigini kontrol et.
        withMessage("Webelementi kontrol et");//--> hata alma durumunda console da bu mesaji verir.--> Zorunlu degil.
